---
title: 'Inference Service Registration'
updated: '2026-03-23'
---
...
After registration is complete, the inference service automatically creates a corresponding [Channel](./channels) in the gateway, thereby being incorporated into the gateway's routing, load balancing, rate limiting, audit, and content moderation systems.
...
![Inference Service Registration List](/assets/screenshots/boss/gateway-service-reg-list.png)
...
> 💡 Tip: Channels created by registration also appear in the [Channel Management](./channels) list, where administrators can further adjust routing priority, rate limiting parameters, and other configurations.
