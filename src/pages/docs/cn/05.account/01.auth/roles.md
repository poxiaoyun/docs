...
:::tip
高层级角色自动拥有低层级的所有权限。例如，租户管理员在其租户范围内拥有开发者和成员的所有权限。
:::
...
:::warning
系统管理员拥有最高权限，请谨慎分配此角色。建议平台仅设置 1-2 个系统管理员，并强制启用 MFA。
:::
...
:::tip
成员角色适用于需要查看项目进展但不需要直接操作资源的人员，如项目经理、产品经理、审计人员等。
:::
...
:::tip
一个用户可以在不同租户中拥有不同的角色。切换租户时，界面会根据您在目标租户中的角色自动调整。
:::

## 注意事项

- 如果发现可用菜单或按钮异常，请尝试刷新页面或重新登录以重新加载权限
