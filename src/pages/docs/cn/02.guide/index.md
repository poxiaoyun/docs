...
| 你的身份 | 推荐路径 |
| --- | --- |
| **开发者** | [快速开始](/guide/quick-start) → [术语表](/guide/glossary) → [在线推理](/rune/console/inference) → [对话体验](/rune/chatapp/) |
...
| **只想体验一下模型** | [快速开始](/guide/quick-start) 的「跑通第一个推理服务」 → [模型体验](/rune/chatapp/experience) |
