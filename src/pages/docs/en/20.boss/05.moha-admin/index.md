...
updated: '2026-03-23'
description: 'The Boss platform operates and manages the Moha model repository - models, datasets, images, Spaces and image sources.'
tags:
  - boss
  - moha-admin
---
...
Moha repository management is a module in the Boss operation platform used to maintain the Moha model repository. Administrators can uniformly manage all models, datasets, and mirror resources in the platform here, review space applications, and configure mirror sources.
