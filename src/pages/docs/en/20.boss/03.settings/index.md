...
updated: '2026-03-23'
description: 'Boss platform system-level configuration - platform parameters, sub-product switches, dynamic dashboard and member management.'
tags:
  - boss
  - settings
---
...
System settings are the global configuration center of the Boss operating platform. Platform administrators can adjust the basic parameters of the platform, control the function switches of each sub-product, configure dynamic dashboards, and manage platform members here.
