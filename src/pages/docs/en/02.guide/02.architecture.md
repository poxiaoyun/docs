...
updated: '2026-09-14'
description: 'Explains in plain language how the platform is layered, how a click travels and where models and data live, so the UI stops feeling like a black box.'
---
...
| --- | --- | --- |
| **Interface layer** | The AI Platform, BOSS, Moha Hub and AIrouter — all parts of the same web application | The place where you click menus and fill in forms |
...
| --- | --- | --- |
| **AI Platform / AIrouter / Moha Hub** | Starts with `/console` | Everyone inside a tenant |
...
It is not a third system. It is a shortcut inside `/console` for moving between the sub-products: the AI Platform, Moha Hub and AIrouter. All three share the same sign-in state and tenant identity.
...
| `/api/ai` | Metrics and storage service | Instance runtime metrics, storage volumes and storage jobs |
...
| **Model gateway** | A gateway dedicated to model-call traffic; it routes conversation requests to a model, applies rate limits, runs content moderation and records usage | AIrouter, Marketplace, API Keys, Usage analysis |
